...
$onn = mysql_connect('localhost','root','contact_db') or die('connection failed');

if(isset($_POST['submit'])){
   $naam = mysql_escape_string($conn, $_POST['naam']);
   $Email = mysql_escape_string($conn, $_POST['Email']);
   $Telefoonnummer = $_POST['Telefoonnummer'];
   $afspraaksdatum = $_POST['afspraaksdatum'];

   $insert = mysql_query($conn,"INSERT INTO 'contact_form'(naam, Email,Telefoonnummer, afspraaksdatum )
   VALUES ('$naam','$Email','$Telefoonnummer','$afspraaksdatum')") or die('query failed');
...
<section class="footer">
   ...
   <div class="credit">  <?php echo date('Y'); ?> van <span>Tofigh Heydari & Nigel Rijnschot</span>  </div>
